    ...
    <ssgoi-transition id="/jaemin">
      ...
      >
        ...
        <div class="text-center mb-16 max-w-3xl mx-auto">
          ...
          <div
            class="inline-block bg-white/10 px-8 py-4 rounded-full backdrop-blur-md border border-white/20"
          >
            Created by Jaemin ✨
          </div>
        </div>
        ...
        <div class="max-w-6xl mx-auto mb-16">
          ...
          >
            @for (feature of features; track feature.title) {
              <div
                class="bg-white/10 p-8 rounded-2xl backdrop-blur-md border border-white/20 transition-transform duration-300 hover:-translate-y-1"
              >
        ...
        <div class="max-w-6xl mx-auto mb-16">
          ...
          <div
            class="grid grid-cols-[repeat(auto-fit,minmax(250px,1fr))] gap-6"
          >
                ...
                <div class="relative z-10">
                  ...
                  <div class="flex gap-2 flex-wrap">
                    @for (tag of tags; track tag) {
                      <span
                        class="px-3 py-1 bg-white/20 rounded-full text-xs"
                        >{{ tag }}</span
                      >
                    }
                  </div>
        ...
        <div class="max-w-6xl mx-auto mb-16">
          ...
          @for (item of contentBlocks; track item) {
            <div
              class="mb-12 bg-white/10 p-8 rounded-2xl backdrop-blur-md border border-white/20"
            >
        ...
        <!-- Footer -->
        <div
          class="text-center mt-16 p-12 bg-black/20 rounded-3xl backdrop-blur-md border border-white/10 max-w-2xl mx-auto"
        >
