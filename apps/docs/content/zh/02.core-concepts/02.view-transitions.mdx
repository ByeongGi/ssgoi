...
<Tabs items={[{ label: "React", value: "react" }, { label: "Svelte", value: "svelte" }, { label: "Angular", value: "angular" }]}>
  ...
  <TabPanel value="angular">
    ...
    import { SsgoiComponent } from '@ssgoi/angular';
...
<Tabs items={[{ label: "React", value: "react" }, { label: "Svelte", value: "svelte" }, { label: "Angular", value: "angular" }]}>
  ...
  <TabPanel value="angular">
    ```typescript
    import { Component } from '@angular/core';
    import { SsgoiTransitionComponent } from '@ssgoi/angular';

    @Component({
      selector: 'app-page',
      standalone: true,
      imports: [SsgoiTransitionComponent],
      template: `
        <ssgoi-transition id="/page-path">
          <app-page-content />
        </ssgoi-transition>
      `
    })
