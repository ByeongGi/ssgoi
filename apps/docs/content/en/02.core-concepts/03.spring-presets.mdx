...
<Tabs items={[{ label: "React", value: "react" }, { label: "Svelte", value: "svelte" }, { label: "Vue", value: "vue" }, { label: "Angular", value: "angular" }]}>
  ...
  <TabPanel value="angular">
    ...
    export class AppComponent {
      config: SsgoiConfig = {
        defaultTransition: fade({ spring: springPresets.gentle }),
        transitions: [
          {
            from: '/home',
            to: '/about',
            transition: slide({ spring: springPresets.wobbly })
          }
        ]
      };
    }
...
<Tabs items={[{ label: "React", value: "react" }, { label: "Svelte", value: "svelte" }, { label: "Vue", value: "vue" }, { label: "Angular", value: "angular" }]}>
  ...
  <TabPanel value="angular">
    ...
    import { config as springPresets } from '@ssgoi/angular/presets';
    import type { TransitionParams } from '@ssgoi/angular';
    ...
    @Component({
      ...
      template: `
        <div [ssgoiTransition]="fadeInConfig">
          Content
        </div>
      `
    })
    export class MyComponent {
      fadeInConfig: TransitionParams = {
        key: 'fade-in',
        spring: springPresets.slow,
        in: (element) => ({
          tick: (progress) => {
